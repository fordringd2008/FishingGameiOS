...
// 游走的路径
@property (nonatomic, strong) UIBezierPath *fishPath;

// 动画句柄
@property (nonatomic, strong) CAKeyframeAnimation *animation;

// 模拟鱼的x,y偏移量
@property (nonatomic, assign) CGFloat mOffsetX, mOffsetY;
...
// 自身的宽度
@property (nonatomic, assign) CGFloat fishWidth;
...
// 鱼钩的X,Y坐标
@property (nonatomic, assign) CGFloat hookX, hookY;
...
// 钓到鱼后，向上移动的距离变短
@property (nonatomic, assign) CGFloat catchedOffsetY;
